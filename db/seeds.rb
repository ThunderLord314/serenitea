...
Product.create(name: 'Lobster Mug', description: 'A short mug with an image of a lobster on the side', quantity: '8', price: '4.99', shipping_info: 'fragile', category: 'accessory')
Product.create(name: 'Flower Mug', description: 'A mediuim-sized mug with an image of a flower on the side', quantity: '5', price: '5.99', shipping_info: 'fragile', category: 'accessory')
Product.create(name: 'Porcelain Cup', description: 'A petite and simplistic tea cup', quantity: '13', price: '4.99', shipping_info: 'fragile', category: 'accessory')
Product.create(name: 'Porcelain Tea Pot', description: 'An elegant and minimalist tea pot', quantity: '5', price: '13.99', shipping_info: 'fragile', category: 'accessory')
